  ...
  methods: {
    SplitProblems(string){
      ...
      checked.forEach(function(item){
            if(item=='----->'){
                newChecked.push(item.replace('----->','<span style="color:blue; background-color: rgba(172, 209, 244, 0.2); font-weight: bold; border-radius: 3px; width: auto;  height: auto; padding: 2px 2px 2px 2px; margin-left:2px;margin-right:2px">'));
            }else if (item=='!!!'){
